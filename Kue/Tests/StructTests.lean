...
theorem format_non_regular_field_classes :
    formatValue
      (mkStruct [
          ...
          ⟨"b", .required, .kind .string, false⟩,
          ⟨"_c", .hidden, .prim (.bool true), false⟩,
          ⟨"#D", .definition, .kind .bool, false⟩
        ] .regularOpen none [])
...
theorem format_let_bindings_are_not_output_fields :
    formatValue
      (mkStruct [⟨"base", .letBinding, .prim (.int 2), false⟩, ⟨"x", .regular, .prim (.int 2), false⟩] .regularOpen none [])
      = "{x: 2}" := by
  native_decide
...
theorem meet_disjoint_regular_structs :
    meet
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      (mkStruct [⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      =
        mkStruct [
...
theorem meet_same_regular_field :
    meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_conflicting_regular_field_bottoms_struct :
    meet
      ...
      = mkStruct [⟨"a", .regular, .bottomWith [.fieldConflict "a"], false⟩] .regularOpen none [] := by
  rfl

theorem meet_optional_field_waits_when_absent :
    meet
      (mkStruct [⟨"a", .optional, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      =
        mkStruct [
            ⟨"a", .optional, .kind .int, false⟩,
...
theorem meet_required_field_constrains_regular :
    meet
      (mkStruct [⟨"a", .required, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [] := by
  rfl
...
theorem format_field_level_bottom :
    formatValue (mkStruct [⟨"a", .regular, .bottomWith [.fieldConflict "a"], false⟩] .regularOpen none []) = "{a: _|_}" := by
  native_decide
...
theorem meet_optional_with_required_yields_required :
    meet
      (mkStruct [⟨"a", .optional, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"a", .required, .kind .int, false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .required, .kind .int, false⟩] .regularOpen none [] := by
  rfl

theorem meet_hidden_field_values :
    meet
      (mkStruct [⟨"_a", .hidden, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"_a", .hidden, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"_a", .hidden, .prim (.int 1), false⟩] .regularOpen none [] := by
  rfl

theorem meet_definition_field_values :
    meet
      (mkStruct [⟨"#A", .definition, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"#A", .definition, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"#A", .definition, .prim (.int 1), false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_optional_definition_with_provided_definition :
    meet
      (mkStruct [⟨"#x", .field true false .optional, .kind .string, false⟩] .regularOpen none [])
      (mkStruct [⟨"#x", .definition, .prim (.string "hi"), false⟩] .regularOpen none [])
      = mkStruct [⟨"#x", .definition, .prim (.string "hi"), false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_optional_hidden_with_provided_hidden :
    meet
      (mkStruct [⟨"_x", .field false true .optional, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"_x", .hidden, .prim (.int 5), false⟩] .regularOpen none [])
      = mkStruct [⟨"_x", .hidden, .prim (.int 5), false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_required_definition_discharged_by_value :
    meet
      (mkStruct [⟨"#y", .field true false .required, .kind .int, false⟩] .regularOpen none [])
      (mkStruct [⟨"#y", .definition, .prim (.int 3), false⟩] .regularOpen none [])
      = mkStruct [⟨"#y", .definition, .prim (.int 3), false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_closed_struct_allows_matching_field :
    meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .defClosed none [] [⟨["a"], []⟩] := by
  rfl
...
theorem format_typed_ellipsis :
    formatValue (mkStruct [⟨"a", .regular, .kind .int, false⟩] .defOpenViaTail (some (.kind .string)) [])
      = "{a: int, ...string}" := by
  native_decide

theorem format_untyped_struct_ellipsis :
    formatValue (mkStruct [⟨"a", .regular, .kind .int, false⟩] .defOpenViaTail (some .top) [])
      = "{a: int, ...}" := by
  native_decide
...
theorem format_regular_field_label_requiring_quotes :
    formatValue (mkStruct [⟨"a.z", .regular, .prim (.int 1), false⟩] .regularOpen none []) = "{\"a.z\": 1}" := by
  native_decide
...
theorem meet_typed_ellipsis_rejects_conflicting_extra_field :
    meet
      ...
      =
        mkStruct [
            ⟨"a", .regular, .prim (.int 1), false⟩,
            ⟨"b", .regular, .bottomWith [.fieldConstraint "b"], false⟩
          ] .defOpenViaTail (some (.kind .string)) [] := by
  rfl
...
theorem meet_typed_ellipsis_does_not_constrain_declared_field_by_tail :
    meet
      (mkStruct [⟨"a", .regular, .kind .int, false⟩] .defOpenViaTail (some (.kind .string)) [])
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .defOpenViaTail (some (.kind .string)) [] := by
  rfl

theorem meet_nested_struct_field_uses_struct_meet :
    meet
      (mkStruct [⟨"x", .regular, mkStruct [⟨"a", .regular, .kind .int, false⟩] .regularOpen none [], false⟩] .regularOpen none [])
      (mkStruct [⟨"x", .regular, mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [], false⟩] .regularOpen none [])
      = mkStruct [⟨"x", .regular, mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [], false⟩] .regularOpen none [] := by
  rfl
...
theorem meet_string_pattern_constrains_regular_field :
    meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl
...
theorem meet_string_pattern_rejects_conflicting_regular_field :
    meet
      (mkStruct [] .regularOpen none [((.kind .string), (.kind .int))])
      (mkStruct [⟨"a", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .bottomWith [.fieldConstraint "a"], false⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl

theorem meet_string_pattern_constrains_declared_pattern_field :
    meet
      (mkStruct [⟨"a", .regular, .kind .number, false⟩] .regularOpen none [((.kind .string), (.kind .int))])
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [])
      = mkStruct [⟨"a", .regular, .prim (.int 1), false⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl
...
theorem meet_exact_label_pattern_skips_other_regular_fields :
    meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      =
        mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [((.prim (.string "a")), (.kind .int))] := by
  rfl
...
theorem meet_exact_label_pattern_rejects_matching_conflict :
    meet
      ...
      =
        mkStruct [⟨"a", .regular, .bottomWith [.fieldConstraint "a"], false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [((.prim (.string "a")), (.kind .int))] := by
  rfl
...
theorem meet_regex_label_pattern_skips_non_matching_regular_fields :
    (meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      ==
        mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [((.stringRegex "^a$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_label_pattern_rejects_matching_conflict :
    (meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.string "x"), false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [])
      ==
        mkStruct [⟨"a", .regular, .bottomWith [.fieldConstraint "a"], false⟩, ⟨"b", .regular, .prim (.string "x"), false⟩] .regularOpen none [((.stringRegex "^a$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_wildcard_label_pattern_constrains_matching_field :
    (meet
      ...
      ==
        mkStruct [⟨"abcz", .regular, .prim (.int 1), false⟩, ⟨"abcy", .regular, .prim (.string "skip"), false⟩] .regularOpen none [((.stringRegex "^a.*z$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_wildcard_label_pattern_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"abcz", .regular, .bottomWith [.fieldConstraint "abcz"], false⟩,
            ⟨"abcy", .regular, .prim (.string "skip"), false⟩
...
theorem meet_regex_plus_label_pattern_requires_one_character :
    (meet
      ...
      ==
        mkStruct [⟨"az", .regular, .prim (.string "skip"), false⟩, ⟨"abz", .regular, .prim (.int 2), false⟩] .regularOpen none [((.stringRegex "^a.+z$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_question_label_pattern_allows_zero_or_one_atom :
    (meet
      ...
      ==
        mkStruct [
            ⟨"color", .regular, .bottomWith [.fieldConstraint "color"], false⟩,
            ⟨"colour", .regular, .prim (.int 2), false⟩,
            ⟨"colouur", .regular, .prim (.string "skip"), false⟩
...
theorem meet_regex_range_label_pattern_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a5z", .regular, .bottomWith [.fieldConstraint "a5z"], false⟩,
            ⟨"axz", .regular, .prim (.string "skip"), false⟩
...
theorem meet_escaped_regex_label_pattern_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a.z", .regular, .bottomWith [.fieldConstraint "a.z"], false⟩,
            ⟨"abz", .regular, .prim (.string "skip"), false⟩
          ] .regularOpen none [((.stringRegex "^a\\.z$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_digit_shorthand_rejects_matching_conflict :
    (meet
      ...
      (mkStruct [⟨"a5z", .regular, .prim (.string "bad"), false⟩, ⟨"adz", .regular, .prim (.string "skip"), false⟩] .regularOpen none [])
      ==
        mkStruct [
            ⟨"a5z", .regular, .bottomWith [.fieldConstraint "a5z"], false⟩,
            ⟨"adz", .regular, .prim (.string "skip"), false⟩
...
theorem meet_regex_negated_digit_shorthand_rejects_matching_conflict :
    (meet
      (mkStruct [] .regularOpen none [((.stringRegex "^a\\Dz$"), (.kind .int))])
      (mkStruct [⟨"a5z", .regular, .prim (.string "skip"), false⟩, ⟨"adz", .regular, .prim (.string "bad"), false⟩] .regularOpen none [])
      ==
        mkStruct [
            ⟨"a5z", .regular, .prim (.string "skip"), false⟩,
            ⟨"adz", .regular, .bottomWith [.fieldConstraint "adz"], false⟩
          ] .regularOpen none [((.stringRegex "^a\\Dz$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_word_shorthand_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a_z", .regular, .bottomWith [.fieldConstraint "a_z"], false⟩,
            ⟨"a-z", .regular, .prim (.string "skip"), false⟩
...
theorem meet_regex_negated_word_shorthand_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a_z", .regular, .prim (.string "skip"), false⟩,
            ⟨"a-z", .regular, .bottomWith [.fieldConstraint "a-z"], false⟩
          ] .regularOpen none [((.stringRegex "^a\\Wz$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_exact_repetition_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a12z", .regular, .bottomWith [.fieldConstraint "a12z"], false⟩,
...
theorem meet_regex_bounded_repetition_rejects_matching_conflict :
    (meet
      ...
      ==
        mkStruct [
            ⟨"a12z", .regular, .prim (.int 2), false⟩,
            ⟨"a123z", .regular, .bottomWith [.fieldConstraint "a123z"], false⟩,
            ⟨"a1z", .regular, .prim (.string "skip"), false⟩
...
theorem meet_regex_top_level_alternation_constrains_each_alternative :
    (meet
      ...
      ==
        mkStruct [
            ⟨"cat", .regular, .bottomWith [.fieldConstraint "cat"], false⟩,
            ⟨"dog", .regular, .prim (.int 2), false⟩,
            ⟨"cow", .regular, .prim (.string "skip"), false⟩
...
theorem meet_multiple_pattern_constraints_remain_independent :
    (meet
      ...
      ==
        mkStruct [
            ⟨"az", .regular, .bottomWith [.fieldConstraint "az"], false⟩,
            ⟨"ax", .regular, .prim (.int 2), false⟩,
            ⟨"bz", .regular, .prim (.string "ok"), false⟩
...
theorem closed_pattern_rejects_non_matching_extra_regular_field :
    (meet
      ...
      (mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .prim (.int 2), false⟩] .regularOpen none [])
      ==
        mkStruct [⟨"a", .regular, .prim (.int 1), false⟩, ⟨"b", .regular, .bottomWith [.fieldNotAllowed "b"], false⟩] .defClosed none [((.stringRegex "^a$"), (.kind .int))] [⟨[], [.stringRegex "^a$"]⟩]) = true := by
  native_decide
...
theorem closed_multiple_patterns_allow_any_matching_regular_field :
    (meet
      ...
      (mkStruct [
          ⟨"ax", .regular, .prim (.int 2), false⟩,
          ⟨"bz", .regular, .prim (.string "ok"), false⟩,
          ⟨"m", .regular, .prim (.int 3), false⟩
        ] .regularOpen none [])
      ==
        mkStruct [
            ⟨"ax", .regular, .prim (.int 2), false⟩,
            ⟨"bz", .regular, .prim (.string "ok"), false⟩,
            ⟨"m", .regular, .bottomWith [.fieldNotAllowed "m"], false⟩
...
theorem disj_struct_arms_no_default_stays_open :
    formatValue
      (.disj [
        (.regular, mkStruct [⟨"a", .regular, .kind .int, false⟩] .regularOpen none []),
        (.regular, mkStruct [⟨"b", .regular, .kind .string, false⟩] .regularOpen none [])])
      = "{a: int} | {b: string}" := by
  native_decide
...
theorem disj_struct_arms_no_default_is_meet_identity :
    meet
      ...
      = .disj [
        (.regular, mkStruct [⟨"a", .regular, .kind .int, false⟩] .regularOpen none []),
        (.regular, mkStruct [⟨"b", .regular, .kind .string, false⟩] .regularOpen none [])] := by
  rfl
...
theorem meet_struct_field_order_is_declaration_order :
    formatValue
      (meet
        ...
        (mkStruct [⟨"a", .regular, .prim (.int 2), false⟩] .regularOpen none []))
      = "{b: 1, a: 2}" := by
  native_decide
