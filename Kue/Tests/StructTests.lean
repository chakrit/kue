...
theorem format_let_bindings_are_not_output_fields :
    formatValue
      (.structN [⟨"base", .letBinding, .prim (.int 2)⟩, ⟨"x", .regular, .prim (.int 2)⟩] .regularOpen none [])
      = "{x: 2}" := by
  native_decide
...
theorem meet_disjoint_regular_structs :
    meet
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      (.structN [⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [])
      =
        .structN [
...
theorem meet_same_regular_field :
    meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [] := by
  rfl
...
theorem meet_conflicting_regular_field_bottoms_struct :
    meet
      ...
      = .structN [⟨"a", .regular, .bottomWith [.fieldConflict "a"]⟩] .regularOpen none [] := by
  rfl

theorem meet_optional_field_waits_when_absent :
    meet
      (.structN [⟨"a", .optional, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [])
      =
        .structN [
            ⟨"a", .optional, .kind .int⟩,
...
theorem meet_required_field_constrains_regular :
    meet
      (.structN [⟨"a", .required, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [] := by
  rfl
...
theorem format_field_level_bottom :
    formatValue (.structN [⟨"a", .regular, .bottomWith [.fieldConflict "a"]⟩] .regularOpen none []) = "{a: _|_}" := by
  native_decide
...
theorem meet_optional_with_required_yields_required :
    meet
      (.structN [⟨"a", .optional, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"a", .required, .kind .int⟩] .regularOpen none [])
      = .structN [⟨"a", .required, .kind .int⟩] .regularOpen none [] := by
  rfl

theorem meet_hidden_field_values :
    meet
      (.structN [⟨"_a", .hidden, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"_a", .hidden, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"_a", .hidden, .prim (.int 1)⟩] .regularOpen none [] := by
  rfl

theorem meet_definition_field_values :
    meet
      (.structN [⟨"#A", .definition, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"#A", .definition, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"#A", .definition, .prim (.int 1)⟩] .regularOpen none [] := by
  rfl
...
theorem meet_optional_definition_with_provided_definition :
    meet
      (.structN [⟨"#x", .field true false .optional, .kind .string⟩] .regularOpen none [])
      (.structN [⟨"#x", .definition, .prim (.string "hi")⟩] .regularOpen none [])
      = .structN [⟨"#x", .definition, .prim (.string "hi")⟩] .regularOpen none [] := by
  rfl
...
theorem meet_optional_hidden_with_provided_hidden :
    meet
      (.structN [⟨"_x", .field false true .optional, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"_x", .hidden, .prim (.int 5)⟩] .regularOpen none [])
      = .structN [⟨"_x", .hidden, .prim (.int 5)⟩] .regularOpen none [] := by
  rfl
...
theorem meet_required_definition_discharged_by_value :
    meet
      (.structN [⟨"#y", .field true false .required, .kind .int⟩] .regularOpen none [])
      (.structN [⟨"#y", .definition, .prim (.int 3)⟩] .regularOpen none [])
      = .structN [⟨"#y", .definition, .prim (.int 3)⟩] .regularOpen none [] := by
  rfl
...
theorem meet_closed_struct_allows_matching_field :
    meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .defClosed none [] := by
  rfl
...
theorem format_typed_ellipsis :
    formatValue (.structN [⟨"a", .regular, .kind .int⟩] .defOpenViaTail (some (.kind .string)) [])
      = "{a: int, ...string}" := by
  native_decide

theorem format_untyped_struct_ellipsis :
    formatValue (.structN [⟨"a", .regular, .kind .int⟩] .defOpenViaTail (some .top) [])
      = "{a: int, ...}" := by
  native_decide

theorem format_string_pattern_constraint :
    formatValue (.structN [] .regularOpen none [((.kind .string), (.kind .int))]) = "{[string]: int}" := by
  native_decide

theorem format_exact_label_pattern_constraint :
    formatValue (.structN [] .regularOpen none [((.prim (.string "a")), (.kind .int))]) = "{[\"a\"]: int}" := by
  native_decide

theorem format_regex_label_pattern_constraint :
    formatValue (.structN [] .regularOpen none [((.stringRegex "^a$"), (.kind .int))]) = "{[=~\"^a$\"]: int}" := by
  native_decide
...
theorem format_regular_field_label_requiring_quotes :
    formatValue (.structN [⟨"a.z", .regular, .prim (.int 1)⟩] .regularOpen none []) = "{\"a.z\": 1}" := by
  native_decide

theorem format_escaped_regex_label_pattern_constraint :
    formatValue (.structN [] .regularOpen none [((.stringRegex "^a\\.z$"), (.kind .int))])
      = "{[=~\"^a\\\\.z$\"]: int}" := by
  native_decide
...
theorem meet_typed_ellipsis_does_not_constrain_declared_field_by_tail :
    meet
      (.structN [⟨"a", .regular, .kind .int⟩] .defOpenViaTail (some (.kind .string)) [])
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .defOpenViaTail (some (.kind .string)) [] := by
  rfl

theorem meet_nested_struct_field_uses_struct_meet :
    meet
      (.structN [⟨"x", .regular, .structN [⟨"a", .regular, .kind .int⟩] .regularOpen none []⟩] .regularOpen none [])
      (.structN [⟨"x", .regular, .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none []⟩] .regularOpen none [])
      = .structN [⟨"x", .regular, .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none []⟩] .regularOpen none [] := by
  rfl
...
theorem meet_string_pattern_constrains_regular_field :
    meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl
...
theorem meet_string_pattern_rejects_conflicting_regular_field :
    meet
      (.structN [] .regularOpen none [((.kind .string), (.kind .int))])
      (.structN [⟨"a", .regular, .prim (.string "x")⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .bottomWith [.fieldConstraint "a"]⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl

theorem meet_string_pattern_constrains_declared_pattern_field :
    meet
      (.structN [⟨"a", .regular, .kind .number⟩] .regularOpen none [((.kind .string), (.kind .int))])
      (.structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [])
      = .structN [⟨"a", .regular, .prim (.int 1)⟩] .regularOpen none [((.kind .string), (.kind .int))] := by
  rfl
...
theorem meet_exact_label_pattern_skips_other_regular_fields :
    meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [])
      =
        .structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [((.prim (.string "a")), (.kind .int))] := by
  rfl
...
theorem meet_exact_label_pattern_rejects_matching_conflict :
    meet
      ...
      =
        .structN [⟨"a", .regular, .bottomWith [.fieldConstraint "a"]⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [((.prim (.string "a")), (.kind .int))] := by
  rfl
...
theorem meet_regex_label_pattern_skips_non_matching_regular_fields :
    (meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [])
      ==
        .structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [((.stringRegex "^a$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_label_pattern_rejects_matching_conflict :
    (meet
      ...
      (.structN [⟨"a", .regular, .prim (.string "x")⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [])
      ==
        .structN [⟨"a", .regular, .bottomWith [.fieldConstraint "a"]⟩, ⟨"b", .regular, .prim (.string "x")⟩] .regularOpen none [((.stringRegex "^a$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_wildcard_label_pattern_constrains_matching_field :
    (meet
      ...
      ==
        .structN [⟨"abcz", .regular, .prim (.int 1)⟩, ⟨"abcy", .regular, .prim (.string "skip")⟩] .regularOpen none [((.stringRegex "^a.*z$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_plus_label_pattern_requires_one_character :
    (meet
      ...
      ==
        .structN [⟨"az", .regular, .prim (.string "skip")⟩, ⟨"abz", .regular, .prim (.int 2)⟩] .regularOpen none [((.stringRegex "^a.+z$"), (.kind .int))]) = true := by
  native_decide
...
theorem meet_regex_negated_digit_shorthand_rejects_matching_conflict :
    (meet
      (.structN [] .regularOpen none [((.stringRegex "^a\\Dz$"), (.kind .int))])
      (.structN [⟨"a5z", .regular, .prim (.string "skip")⟩, ⟨"adz", .regular, .prim (.string "bad")⟩] .regularOpen none [])
      ==
        .structN [
...
theorem close_value_marks_struct_pattern_closed :
    closeValue (.structN [] .regularOpen none [((.stringRegex "^a$"), (.kind .int))])
      = .structN [] .defClosed none [((.stringRegex "^a$"), (.kind .int))] := by
  rfl
...
theorem closed_pattern_rejects_non_matching_extra_regular_field :
    (meet
      ...
      (.structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .prim (.int 2)⟩] .regularOpen none [])
      ==
        .structN [⟨"a", .regular, .prim (.int 1)⟩, ⟨"b", .regular, .bottomWith [.fieldNotAllowed "b"]⟩] .defClosed none [((.stringRegex "^a$"), (.kind .int))]) = true := by
  native_decide
