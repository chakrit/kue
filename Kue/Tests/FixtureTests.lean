...
private def gtZero : Value := .boundConstraint (.int 0 .number) .gt
...
theorem fixture_int_bound_disjunction :
    formatField "x" (join (.boundConstraint (.int 5 .number) .ge) (.boundConstraint (.int 0 .number) .ge)) = "x: >=0" := by
  native_decide
...
theorem fixture_number_int_bound :
    formatField "x" (meet (meet (.kind .number) (.boundConstraint (.int 0 .number) .ge)) (.prim (.int 7))) = "x: 7" := by
  native_decide
