...
theorem meet_struct_field_open_list_tail_with_longer_closed_list :
    meet
      (.structN [⟨"x", .regular, .listTail [.kind .int] (.kind .string)⟩] .regularOpen none [])
      (.structN [⟨"x", .regular, .list [.prim (.int 1), .prim (.string "x")]⟩] .regularOpen none [])
      = .structN [⟨"x", .regular, .list [.prim (.int 1), .prim (.string "x")]⟩] .regularOpen none [] := by
  rfl

theorem meet_struct_field_open_list_tail_preserves_extra_bottom :
    meet
      (.structN [⟨"x", .regular, .listTail [.kind .int] (.kind .string)⟩] .regularOpen none [])
      (.structN [⟨"x", .regular, .list [.prim (.int 1), .prim (.int 2)]⟩] .regularOpen none [])
      = .structN [⟨"x", .regular, .list [.prim (.int 1), .bottomWith [.kindConflict .string .int]]⟩] .regularOpen none [] := by
  rfl

theorem meet_struct_field_closed_list_uses_list_meet :
    meet
      (.structN [⟨"x", .regular, .list [.kind .int, .kind .string]⟩] .regularOpen none [])
      (.structN [⟨"x", .regular, .list [.prim (.int 1), .prim (.string "x")]⟩] .regularOpen none [])
      = .structN [⟨"x", .regular, .list [.prim (.int 1), .prim (.string "x")]⟩] .regularOpen none [] := by
  rfl
...
theorem meet_hidden_struct_list_is_embedded_list :
    (meet (.structN [⟨"#a", .definition, .prim (.int 1)⟩] .regularOpen none [])
          (.list [.prim (.int 1), .prim (.int 2)])
...
theorem meet_empty_struct_list_is_embedded_list :
    (meet (.structN [] .regularOpen none []) (.list [.prim (.int 7)])
